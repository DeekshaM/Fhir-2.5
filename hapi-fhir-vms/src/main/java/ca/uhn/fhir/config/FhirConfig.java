...
import ca.uhn.fhir.mvc.SubscriptionPlaygroundController;
...
public class FhirConfig {
	 ...
	 * address here.
	 * 
	 * Note the use of the lo variable below. This will be replaced with
	 * the base URL as reported by the server itself. Often for a simple Tomcat
	 * (or other container) installation, this will end up being something
	 * like "http://localhost:8080/hapi-fhir". If you are
	...
	public TesterConfig testerConfig() {
		...
		retVal
				...
				.withName("VANI MEDICAL SOLUTIONS");
